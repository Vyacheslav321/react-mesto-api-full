...
В работе реализованы регистрация и авторизация на проекте mesto-react из прошлой проектной работы. Запросы на авторизацию, регистрацию и проверку токена реализованы через сервис https://auth.nomoreparties.co. 
